...
//     constructor(editor, connection) {
//         this.editor = editor;
//         this.outputNode = connection.output.node;
//         this.inputNode = connection.input.node;
//         this.outputName = connection.output.key;
//         this.inputName = connection.input.key;
//         console.log('ConnectionProxy constructor', this.connection);
//     }
//     getConnection() {
//         const input = this.inputNode.inputs.get(this.inputName);
//         const output = this.outputNode.outputs.get(this.outputName);
//         if (input !== null && output !== null) {
//             for (const conn of input.connections) {
//                 if (conn.output === output) {
//                     console.log('ConnectionProxy.getConnection conn found:', conn);
//                     return conn;
//                 }
//             }
//         }
...
//         console.log('ConnectionProxy disconnecting', conn);
//         this.editor.removeConnection(conn);
//     }
//     connect() {
//         console.log('ConnectionProxy connecting', this.outputNode.id, this.outputName, 'to', this.inputNode.id, this.inputName);
//         const output = this.outputNode.outputs.get(this.outputName);
//         const input = this.inputNode.inputs.get(this.inputName);
//         console.log('ConnectionProxy connecting', output, 'to', input);
//         console.log('ConnectionProxy editor', this.editor);
//         this.editor.connect(output, input); // TODO this adds undo history item which breaks my stack...
//     }
// };

// // Use the 'safe' variants when inputs/outputs are dynamically removed as part of the same set of actions
// // (This is needed because removing an input/output invalidates the previous connection object, so we have to look up connections on demand)
// export class SafeAddConnectionAction extends Action {
//     constructor(editor, connection) {
//         console.log('SafeAddConnectionAction constructor', editor, connection);
//         super();
//         this.connectionProxy = new ConnectionProxy(editor, connection);
//     }
//     undo() {
//         console.log('SafeAddConnectionAction undo, removing', this.connectionProxy);
//         this.connectionProxy.disconnect();
//     }
//     redo() {
//         console.log('SafeAddConnectionAction redo, connecting', this.connectionProxy);
//         this.connectionProxy.connect();
//     }
// }

// export class SafeRemoveConnectionAction extends Action {
//     constructor(editor, connection) {
//         console.log('SafeRemoveConnectionAction constructor', editor, connection);
//         super();
//         this.connectionProxy = new ConnectionProxy(editor, connection);
//     }
//     undo() {
//         console.log('SafeRemoveConnectionAction undo, connecting', this.connectionProxy);
//         this.connectionProxy.connect();
//     }
//     redo() {
//         console.log('SafeRemoveConnectionAction redo, removing', this.connectionProxy);
//         this.connectionProxy.disconnect();
//     }
// }
